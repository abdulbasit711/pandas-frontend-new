...
function PurchaseReport() {
  ...
  const calculateTotals = (data) => {
    const totalPurchaseCounter = data.reduce((acc, item) => acc + Number(item.totalAmount), 0);
  ...
  const viewPurchase = (purchaseId) => {
    navigate(`/${primaryPath}/purchases/view-purchase/${purchaseId}`);
  };
        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-11 gap-2">
          ...
          <div className="border p-2 rounded col-span-2">
            ...
            <select
              ...
              onChange={(e) => setFilters((prev) => ({ ...prev, vendorSupplierId: e.target.value }))}
            >
          ...
          <div className="border p-2 rounded col-span-2">
            ...
            <select
              ...
              onChange={(e) => setFilters((prev) => ({ ...prev, vendorCompanyId: e.target.value }))}
            >
                ...
                paginatedPurchases.map((purchase, index) => (
                  ...
                  >
                    ...
                    <td className="py-2 px-2">
                      {purchase.vendorSupplierId?.supplierName || purchase.vendorCompanyId?.companyName}
                    </td>
                  </tr>
                ))
              ) : (
